...
namespace TournamentCenter
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            MailMessage email = new MailMessage(new MailAddress("noreply@tournamentcenter.com", "(do not reply)"),
            ...
            using (var mailClient = new TournamentCenter.GmailEmailService())
            {
